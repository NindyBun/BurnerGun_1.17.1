...
public class TrashProvider implements ICapabilitySerializable<INBT> {
     ...
     */
    private TrashHandler getCachedInventory() {
        if (trashHandler == null) {
            trashHandler = new TrashHandler(TrashContainer.MAX_EXPECTED_HANDLER_SLOT_COUNT);
        }
        return trashHandler;
    }

    private TrashHandler trashHandler;  // initially null until our first call to getCachedInventory
