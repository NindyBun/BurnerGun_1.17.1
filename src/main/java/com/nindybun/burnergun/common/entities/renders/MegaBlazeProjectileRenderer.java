...
public class MegaBlazeProjectileRenderer extends EntityRenderer<MegaBlazeProjectileEntity> {
    ...
    public MegaBlazeProjectileRenderer(EntityRendererManager p_i46179_1_) {
        super(p_i46179_1_);
    }

    @Override
    public void render(MegaBlazeProjectileEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    @Override
    protected int getBlockLightLevel(MegaBlazeProjectileEntity p_225624_1_, BlockPos p_225624_2_) {
        return 15;
    }
